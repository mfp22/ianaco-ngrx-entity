...
import { AnimateTextComponent } from './animate-text/animate-text.component';
...
export * from './animate-text/animate-text.component';
export * from './animate-content/animate-content.component';
// exports group
